...
CHARACTER(200)               :: FormStr7
CHARACTER(200)               :: FormStr8
CHARACTER(200)               :: FormStr9
CHARACTER(200)               :: FormStr10
CHARACTER(200)               :: FormStr11
CHARACTER(200)               :: FormStr12


FormStr  = "('#' / '#' 'This full-field turbulence file was generated by ' , A , A , ' on ' , A , ' at ' , A , '.' )"
FormStr1 = "('#' / '# |  Y  x  Z  | Grid Resolution (Y x Z) | Time-step | Hub Elev | Mean U |')"
FormStr2 = "('#' I5,I6,F11.3,F11.3,F15.3,F11.2,F10.2)"
FormStr3 = "('#'/,'GWF Type  33')"
FormStr4 = "('#'/,'#                     nX    nY    nZ    nSteps  ParamCode(Elev,Velo,Acc,Press)')"
FormStr5 = "('GWF KeyData Size       1 ',I5, I5, I8,'  11' )"
FormStr6 = "('#'/,'GWF Keydata CoordSys  '   F8.4, F10.4, F10.4 )"
FormStr7 = "(F25.4, F10.4, F10.4)"
FormStr8 = "(' GWF Grid    ', A ,'      Constant ' F10.3, F12.3 )"
FormStr9 = "('!' '   Vx     Vy    Vz')"
FormStr10= "(F10.4, F10.4, F10.4)"
FormStr11= "('#'/,'GWF Time  ' ,F8.4 )"
FormStr12= "('#'/,'GWF WindVector ')"


CALL GetNewUnit(UFFF)

CALL WrScr ( ' Generating vpOne formatted file '//TRIM(RootName)//'.w33.' )
...
WRITE (UFFF,FormStr )  TRIM(GetNVD(TurbSim_Ver)), CurDate(), CurTime()
WRITE (UFFF,FormStr1)
...
WRITE (UFFF,FormStr3)  ! GWF Type
WRITE (UFFF,FormStr4)  ! Description
WRITE (UFFF,FormStr5)  p_grid%NumGrid_Y, p_grid%NumGrid_Z, p_grid%NumOutSteps
WRITE (UFFF,FormStr6)  real(1), real(0), real(0)
WRITE (UFFF,FormStr7)  real(0), real(1), real(0)
WRITE (UFFF,FormStr7)  real(0), real(0), real(1)
WRITE (UFFF,FormStr7)  real(0), real(0), real(0)
WRITE (UFFF,"('#')")
WRITE (UFFF,FormStr8)  "X", REAL(0), REAL(0)
...
! Write mean wind speed in all points - no power law is used here (for now) JT Horn
    WRITE (UFFF,FormStr9)
DO IY=1,p_grid%NumGrid_Y
DO IZ=1,p_grid%NumGrid_Z

WRITE(UFFF,FormStr10)  UHub, real(0), real(0) ! Changed from U(IZ) to UHub - JT Horn
...
WRITE(UFFF,FormStr11) (IT-1)*p_grid%TimeStep
WRITE(UFFF,FormStr12)
WRITE(UFFF,FormStr9)
DO IY=1,p_grid%NumGrid_Y
DO IZ=1,p_grid%NumGrid_Z  ! From the top to the bottom

WRITE(UFFF,FormStr10) V(IT,(IZ-1)*p_grid%NumGrid_Y+IY,1), V(IT,(IZ-1)*p_grid%NumGrid_Y+IY,2), V(IT,(IZ-1)*p_grid%NumGrid_Y+IY,3)
